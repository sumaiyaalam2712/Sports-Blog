...
class IndexController extends Controller
{
  public function index()
  {
    ...
    return view('frontend.layout.index',['scores'=>$score,'all_newses'=>$all,'tops'=>$top,'toptwo'=>$top2,'top1'=>$top1,'transfer1'=>$transfer1,'transfertwo'=>$transfer2,'features'=>$feature]);
  }
}